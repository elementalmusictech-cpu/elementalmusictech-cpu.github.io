...
export const metadata = {
  title: "Prism Docs — Guides & Feature References",
  description: "Documentation for Prism: getting started guides, feature deep-dives, and workflow recipes for the 16-track AUv3 MIDI step sequencer.",
};
