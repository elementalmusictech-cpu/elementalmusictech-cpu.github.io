...
export default function PrismHome() {
  return (
    <main>
      ...
      {/* ── 2. Pitch (stats) ── */}
      <section className="flex flex-col items-center justify-center px-6" style={{ paddingTop: "100px", paddingBottom: "0px"}}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full mb-12">
          <div className="border border-[var(--border)] rounded-sm p-8 bg-[var(--bg-secondary)]">
    ...
    {/* ── 1b. Positioning ── */}
    <section style={{ paddingTop: "0px", paddingBottom: "100px", paddingLeft: "2.5rem", paddingRight: "2.5rem" }}>
      ...
      {/* <div className="relative max-w-2xl mx-auto text-center">
        <div className="backdrop-blur-md bg-black/20 border border-white/10 rounded-2xl px-8 py-6">
          <p className="text-xl md:text-2xl text-white leading-relaxed">
            Prism competes with $1,000 hardware sequencers. It runs on the iPhone in your pocket.{" "}
            <span className="font-semibold">
              It has capabilities none of them do.
            </span>
          </p>
        </div>
      </div> */}
    ...
    {/* </section> */}
      ...
      {/* ── Two Track Types ── */}
      <section className="py-24 px-6 border-[var(--border)]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">

          {/* Drums Column */}
          <div>
            <p className="font-mono text-xs tracking-[0.2em] uppercase text-[var(--text-tertiary)] mb-4">Drum Tracks</p>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">16 Pads. <span className="text-[var(--cta)]">16 Sequencers.</span></h2>
            <p className="text-[var(--text-secondary)] text-lg mb-8 max-w-lg">Every pad is its own independent sequencer — with its own length, resolution, and Step FX. Your kick runs 16 steps while your hi-hat runs 7 and your snare runs 5. Polyrhythmic drums from a single track.</p>
            <div className="space-y-0">
              {[
                ...
                <div key={item.label} className="flex gap-4 items-start py-5 border-t border-[var(--border)]">
                  <div>
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Scale-Locked. <span className="text-[var(--cta)]">Everywhere.</span></h2>
            <p className="text-[var(--text-secondary)] text-lg mb-8 max-w-lg">Every input and transformation stays in key — not just the notes you place, but the arpeggiator, Fuse modes, randomization, and even your external MIDI keyboard. 50+ scales, or build your own.</p>
            <div className="space-y-0">
              {[
      ...
      <section className="py-24 px-6  border-[var(--border)]">
          ...
          <div>
            <p className="font-mono text-xs tracking-[0.2em] uppercase text-[var(--text-tertiary)] mb-4">No sequencer at any price has inter-track musical data flow</p>            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Fuse Modes: <span className="text-[var(--cta)]">Peek, Echo, Melt</span></h2>
            <p className="text-[var(--text-secondary)] text-lg mb-8 max-w-lg">Fuse lets tracks share musical data — rhythm, pitch, velocity — creating combinations that neither track could produce alone.</p>
            <div className="space-y-0">
              {FUSE_MODES.map((mode) => (
                <div key={mode.name} className="flex gap-4 items-start py-5 border-t border-[var(--border)]">
          ...
          <div className="rounded-xl overflow-hidden min-h-[480px] lg:min-h-[540px]">
            <MeltDiagram />
          </div>
        </div>
      </section>
      ...
      {/* ── 3b. Chord Blocks ── */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
<p className="font-mono text-xs tracking-[0.2em] uppercase text-[var(--text-tertiary)] mb-4">No sequencer at any price has reference-based chord objects</p>            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Chord Blocks: <span className="text-[var(--cta)]">references, not copies.</span></h2>
            <p className="text-[var(--text-secondary)] text-lg mb-8 max-w-lg">Every chord exists in one place. Place it on any trig, across any track — they all point back to the source. Change the block, and your entire arrangement follows. Instantly.</p>
            <div className="space-y-0">
                {[
      ...
      <section className="py-0 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map((f) => (
              <div key={f.title} className="border border-[var(--border)] rounded-xl p-6 bg-[var(--bg-secondary)] hover:border-[var(--border-hover)] transition-colors">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          {/* <p className="font-mono text-xs tracking-[0.2em] uppercase text-[var(--text-tertiary)] mb-4">Hardware soul, software reach</p> */}
          <ConnectionsDiagram />
          {/* <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">The Hardware Trinity</h2> */}
          {/* <div className="rounded-xl overflow-hidden mb-8">
            <ConnectionsDiagram />
          </div> */}
          <p className="text-[var(--text-secondary)] text-lg max-w-2xl mx-auto mb-6">Prism + Launchpad + Launchkey + Ableton Live. Bidirectional control, RGB feedback, clip launching, and a complete performance rig that costs a fraction of dedicated hardware.</p>
      ...
      {/* ── 4b. Testimonials ── */}
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {[
                ...
                <div key={i} className="border border-[var(--border)] rounded-xl p-6 bg-[var(--bg-secondary)] flex flex-col gap-4">
      ...
      {/* <section className="py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-8">Built by <span className="text-[var(--cta)]">one person</span> who plays this instrument every day.</h2>
          <div className="border border-[var(--border)] border-dashed rounded-xl p-8 bg-[var(--bg-secondary)] mb-8">
            <p className="text-sm text-[var(--text-tertiary)] font-mono">[ Tyler will write 2–3 sentences: solo developer craft, instrument philosophy, community. ]</p>
          </div>
          <div className="flex gap-3 justify-center flex-wrap">
            <a href="#" className="px-5 py-2.5 rounded-lg border border-[var(--border)] text-sm text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--border-hover)] transition-colors">Audiobus Forum ↗</a>
            <span className="px-5 py-2.5 rounded-lg border border-[var(--border)] text-sm text-[var(--text-tertiary)] opacity-60">Discord — coming soon</span>
          </div>
        </div>
      </section> */}

      {/* ── 7. Final CTA ── */}
      <section className="py-24 px-6 bg-[var(--bg-secondary)] border-t border-[var(--border)]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-[var(--text-secondary)] mb-10 max-w-xl mx-auto">16 tracks. Fuse Modes. Chord Blocks. Parameter Locks. Everything you'd expect from a $2,000 sequencer — on iPhone and iPad.</p>
          ...
          <p className="mt-4 text-sm text-[var(--text-secondary)] mt-6">At 2% the cost of a hardware sequencer.</p>
